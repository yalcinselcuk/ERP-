...
{
    public partial class Frm_AltBirimMenu : Frm_AltFisMenu
    {
        ...
        public Frm_AltBirimMenu(Fis fis, int rows)
        {
            InitializeComponent();
            this.fis = fis;
            this.rows = rows;
        ...
        protected override void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            fis.dataGridFis.Rows[rows].Cells[2].Value = kod;
        ...
        protected override void Fill_KodId(int rowIndex)
        {
            ...
            fis.dataGridFis.Rows[rows].Cells[6].Value = id;
