...
namespace Manav
{
    public partial class Frm_AltRenkMenu : Frm_AltFisMenu
    {
        ...
        public Frm_AltRenkMenu(Fis fis, int rows)
        {
            InitializeComponent();
            this.fis = fis;
            this.rows = rows;
        ...
        protected override void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            fis.dataGridFis.Rows[rows].Cells[1].Value = kod;
        ...
        protected override void Fill_KodId(int rowIndex)
        {
            ...
            fis.dataGridFis.Rows[rows].Cells[5].Value = id;
